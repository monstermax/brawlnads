                ...
                <div className="card-body">
                  <div className="row">
                    <div className="col-md-6">
                      <h6 className="text-warning mb-3">Weapon Crafting</h6>
                      <ul className="list-unstyled text-muted">
                        <li className="mb-2">
                          <i className="fas fa-check text-success me-2"></i>
                          Swords, Axes, Bows, and Staves
                        </li>
                        <li className="mb-2">
                          <i className="fas fa-check text-success me-2"></i>
                    ...
                    <div className="col-md-6">
                      <h6 className="text-info mb-3">Artifact Creation</h6>
                      <ul className="list-unstyled text-muted">
                        <li className="mb-2">
                          <i className="fas fa-check text-success me-2"></i>
                        ...
                        <li className="mb-2">
                          <i className="fas fa-check text-success me-2"></i>
                          Essence-based crafting
                        </li>
                        <li className="mb-2">
                          <i className="fas fa-check text-success me-2"></i>
                          Limited charges system
                        </li>
                      </ul>
                    </div>
                  </div>
